...
Consumer.prototype.buildEmptyPayloads = function (payloads) {
    var self = this;
    return payloads.map(function (j) {
        var k = {
          topic: j.topic,
...
Consumer.prototype.fetch = function () {
    ...
    this.fetchRequests++;
    var self = this;
    var fetchDone = function () { self.fetchRequests-- };

    if (this.paused)
      this.client.sendFetchRequest(this, this.buildEmptyPayloads(this.payloads), this.options.fetchMaxWaitMs, 0, fetchDone);
    else
      this.client.sendFetchRequest(this, this.payloads, this.options.fetchMaxWaitMs, this.options.fetchMinBytes, fetchDone);
}
...
Consumer.prototype.close = function (force, cb) {
    ...
    var doClose = function () {
      if (force) {
          self.commit(force, function (err) {
